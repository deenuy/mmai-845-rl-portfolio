import tabular_deenu_gengiti
import windy_gridworld_deenu_gengiti
...
if __name__=='__main__':
    ...
    if run_sarsa:
        print("------ Running SARSA ------")
        # Task 1.2 - Select the proper parameters for you to find a close-to-optimal solution. The total reward should be bigger or equal to -16.
        # INSERT CODE HERE
        rews, table = tabular.sarsa(env, step_size=0.5, epsilon=0.05, gamma=1.0, num_eps=1000)
    ...
    if run_q_learning:
        ...
        # Task 2.3 - Select the proper parameters for you to find a close-to-optimal solution. The total reward should be bigger or equal to -16.
        # INSERT CODE HERE
