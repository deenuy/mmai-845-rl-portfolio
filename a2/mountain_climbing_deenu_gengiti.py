...
class mountainClimbing(gym.Env):
    def __init__(self,
        ...
        # Task A.3: Rewards from the diagram (r= labels):
        self.reward_table = {
    ...
    def step(self, action):
        ...
        # Task B.1: Terminal state is PEAK
        done = True if next_state==PEAK else False

        # Task B.2: Call the reward function
